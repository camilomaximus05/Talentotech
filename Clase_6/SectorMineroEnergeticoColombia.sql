...
CREATE TABLE eficiencia_energetica (
  id_eficiencia INTEGER PRIMARY KEY AUTO_INCREMENT,
  proyecto_id INTEGER,
...
CREATE TABLE estudios (
  id_estudio INTEGER PRIMARY KEY AUTO_INCREMENT,
  nombre TEXT NOT NULL,
  descripcion TEXT DEFAULT NULL,
  fecha DATE DEFAULT NULL,
  proyecto_id INTEGER,
...
CREATE TABLE inversiones (
  id_inversion INTEGER PRIMARY KEY AUTO_INCREMENT,
  proyecto_id INTEGER,
...
CREATE TABLE investigadores (
  id_investigador INTEGER PRIMARY KEY AUTO_INCREMENT,
  nombre TEXT DEFAULT NULL,
...
CREATE TABLE minerales (
  id_mineral INTEGER PRIMARY KEY AUTO_INCREMENT,
  nombre TEXT NOT NULL,
  descripcion TEXT DEFAULT NULL,
  ubicacion TEXT DEFAULT NULL,
  proyecto_asociado INTEGER,
